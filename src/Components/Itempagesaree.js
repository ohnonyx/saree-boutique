        ...
        <div className="productful">
            ...
            <div className="image-container">
                        <div className='sub-images-container'>
                            <img src={saree.images[0]} onClick={() => setMainImage(saree.images[0])} alt="saree1" />
                            <img src={saree.images[1]} onClick={() => setMainImage(saree.images[1])} alt="saree2" />
                            <img src={saree.images[2]} onClick={() => setMainImage(saree.images[2])} alt="saree3" />
                        </div>
