...
const ItemPage = () => {
    ...
    // Get userId (assuming you have a way to get it, e.g., via context or props)
    const userId = 'userId';  // Replace with actual userId (e.g., from context, or logged-in user's state)
        ...
        <div className="productful">
            ...
            <div className="item-page">
                ...
                <div className="details-container">
                    ...
                    <p className='IDitemid'>Item ID : {jewel._id}</p>
                    <p className='SVG'>
